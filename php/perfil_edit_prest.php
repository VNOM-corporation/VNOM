...
<body>
    ...
    <form action="perfil_update_prest.php" method="POST" enctype="multipart/form-data">
                ...
                <section class="projects section">
                    <div class="section-inner">
                        ...
                        <div class="content">
                            ...
                            <div class="item" style="background-color:#f1f1f1; padding: 20px; border-radius: 10px;">
                               <label>Nome Completo</label> <input placeholder="Nome Completo" class="isd" readonly value="$nomecomp" type="text"/>
                               <br><br>
                               <label>CPF</label> <input placeholder="000.000.000-00"  class="isd" readonly value="$cpf_user" type="text"/>
                                <br><br>
                                <label>Data de Nascimento</label> <input placeholder="dd/mm/yyyy" class="isd" readonly value="$dtnasc_user" type="date"/>
                                <br><br>
                                <label>Sexo</label> <input placeholder="Sexo" class="isd" readonly value="$sexo_user" type="text"/>
                    ...
                    <div class="section-inner">
                        ...
                        <div class="content">
                            <ul class="list-unstyled">
                                <li><i class="fa fa-pencil"></i><a href="#" style="text-decoration: none;">Editar Perfil</a></li>
                                <li><i class="fa fa-arrow-left"></i><a href="perfil_prest.php">Perfil</a></li>
                            </ul>
                        </div><!--//content-->  
                    </div><!--//section-inner-->                 
                </aside><!--//aside-->
