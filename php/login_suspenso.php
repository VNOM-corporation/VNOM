			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="logando.php" method="post">
					<span class="login100-form-title">
						Log-in
						<br><br>
						<marquee><h5 style="color:#03989E;">Sua conta foi banida ou suspensa!</h5></marquee>
					</span>


					<div class="wrap-input100 validate-input" data-validate = "E-mail inválido">
						<input class="input100" type="text" name="login" placeholder="E-mail, Usuário" required>
