...
$update->bindParam(16, $_SESSION['id_user']);
...
$update->bindParam(15, $_SESSION['id_user']);
    
$update->execute();

}

echo"<meta http-equiv='refresh' content='0;url=perfil_edit_prest.php'>"; 
exit;
?>