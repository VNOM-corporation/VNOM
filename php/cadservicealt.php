                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <div class="form-input">
                                    ...
                                    <input type="text" name="descricao_serv" id="last_name" value="$desc_serv" placeholder="Observações sobre quem, onde e como" required/>
                                </div>
                                <div class="form-input">
                                ...
                                <div class="form-select">
                                    ...
                                    <div class="select-list">
                                        <select name="categoria_serv" style="width: 100%; padding: 15px; border-radius:9px; border: #ebebeb 1px solid;" required>
                                            ...
                                            <option value="REFORMAS E SERVIÇOS GERAIS" <?=($categoria_serv == 'REFORMAS E SERVIÇOS GERAIS')? 'selected' : ''?>>REFORMAS E SERVIÇOES GERAIS</option>
